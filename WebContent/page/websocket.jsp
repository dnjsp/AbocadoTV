      ...
      <tr>
         <td style="vertical-align: top;">
            <div id="chatArea">
                ...
                <a href="javascript" id="seed">씨앗 선물하기</a>
                <input type="button" value="채팅 금지하기" onclick="chatBan()">
             </div>
         </td>
         <td>
            <div id="chatRoom">
    ...
    <script type="text/javascript">
       ...
       function connectting(){
          if(userText.value.trim()==""){
            ...
            //웹소켓 초기화
            webSocket = new WebSocket("ws://localhost/webSocket/websocktGroupMultiChat.do");
       ...
       function chatBan(){
          var room = document.getElementById("chatRoomName").innerHTML.trim();
          webSocket.send("chatBan", room, null);
          window.open()
       }
